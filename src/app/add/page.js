      ...
      <header className="header-gradient header-decor relative overflow-hidden px-5 sm:px-8 lg:px-12 pt-8 pb-6">
        <div className="max-w-3xl mx-auto relative z-10">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-white">Tambah Tugas Baru</h1>
              <p className="text-white/60 text-xs">Isi detail tugas yang ingin kamu tambahkan</p>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="bg-card rounded-2xl p-5 sm:p-6 shadow-sm border border-border">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                placeholder="Contoh: Buat laporan proyek"
